  ...
  return (
    <aside className="sidebar">
      ...
      <div className="mb-10">
        ...
        <p className="text-xs font-semibold uppercase tracking-widest text-on-surface-faint mt-0.5">
      ...
      {/* Secondary nav */}
      <div className="sidebar-divider mt-6 pt-6 space-y-1">
        <Link href="/empresa" className="sidebar-secondary-item">
        ...
        <button
          ...
          className="sidebar-secondary-item w-full text-left"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
